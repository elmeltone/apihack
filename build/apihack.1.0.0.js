...
/***/ function(module, exports, __webpack_require__) {
	...
	var showImage = __webpack_require__(2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showImage = function showImage(target) {
		...
		if (imgLink1 != null) imageElemLink.attr('href', imgLink1);else {
			imageElemLink.attr('href', imgLink2);
		};
		var imageElemPic = result.find('.image img');
		imageElemPic.attr("src", imgThumb);
	
		var imgCreator = result.find('.image-creator a');
		if (imgLink1 != null) imgCreator.attr('href', imgLink1);else {
			imgCreator.attr('href', imgLink2);
		};
		...
		if (target.title != null) imgNotes.text(target.title);else {
			imgNotes.text("No title");
		};
...
/***/ }
/******/ ]);
//# sourceMappingURL=apihack.1.0.0.js.map