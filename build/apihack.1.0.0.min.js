!function(e){function t(r){if(n[r])return n[r].exports;var i=n[r]={exports:{},id:r,loaded:!1};return e[r].call(i.exports,i,i.exports,t),i.loaded=!0,i.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)}([function(e,t,n){"use strict";var r=n(1),i=n(2),o=n(3),s=(n(4),n(5)),a=function(e,t){var n="http://loc.gov/pictures/search/?q="+e;r.ajax({type:"search",url:n,dataType:"jsonp",data:{fo:"json",sp:t}}).done(function(t){var n=o(e,t.search.hits);r(".results").html(n),r.each(t.results,function(e,t){var n=i(t);r(n).appendTo(".results")})}).done(function(t){var n=s(e),i='<p id="endPage">End results</p>';void 0!=t.pages.next?r(n).appendTo(".results"):r(i).appendTo(".results")})};r(function(){r(".image-getter").on("submit",function(e){e.preventDefault(),r(".results").html("");var t=1,n=r(this).find("input[name='general']").val();a(n,t)}),r(".count").on("click",function(e){e.preventDefault();var t=pageCounter+1;a(query,t)})})},function(e,t,n){var r,i;/*!
